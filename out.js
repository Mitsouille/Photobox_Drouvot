(() => {
  ...
  // modules/config.js
  var API_BASE_URL = "https://webetu.iutnc.univ-lorraine.fr/www/canals5/phox/api";
  var API_PHOTO = (id) => `/photos/${id}`;

  // modules/photoloader.js
  function loadPicture(idPicture) {
    return fetch(API_BASE_URL + API_PHOTO(6)).then((response) => {
      if (response.ok) {
  ...
  function displayPicture(image) {
    ...
    const template = import_handlebars.default.compile(templatePhoto);
    document.querySelector("section#la_photo").innerHTML = template(
      {
        "type": "ressource",
        "photo": {
          "id": 10,
          "titre": "landscape-1112911_1280",
          "file": "img_586d386ce28e0.jpg",
          ...
          "height": 720,
          "url": {
            "href": "/www/canals5/phox/img/large/img_586d386ce28e0.jpg"
          }
        },
        "links": {
          "categorie": {
            "href": "/www/canals5/phox/api/photos/10/categorie/"
          },
          "comments": {
            "href": "/www/canals5/phox/api/photos/10/comments/"
          }
        }
      }
    );
  ...
  async function getPicture(idPicture) {
    ...
    let res = await photoloader_default.loadPicture(idPicture);
    console.log(res);
  }
  getPicture(window.location.hash ? window.location.hash.substr(1) : 105);
  ui_default.displayPicture(test);
})();
